...
public class Map3SceneFadeController : MonoBehaviour
{
    [Header("UI Toolkit")]
    [Tooltip("UIDocument dùng để tạo lớp fade đen phủ toàn màn hình. Kéo Map3HUD hoặc GlobalHUD có UIDocument vào đây.")]
    ...
    public string fadeOverlayName = "map3-scene-fade-overlay";
    ...
    private void SetupOverlay()
    {
        ...
        if (uiDocument == null)
        {
            Debug.LogError("[Map3SceneFadeController] Chưa có UIDocument.");
            return;
        }
        ...
        if (root == null)
        {
            Debug.LogError("[Map3SceneFadeController] Không tìm thấy rootVisualElement.");
            return;
        }
    ...
    public void FadeOutThenLoadScene(string sceneName)
    {
        if (isFading)
        {
            Debug.LogWarning("[Map3SceneFadeController] Đang fade, không gọi lại.");
            return;
        }
    ...
    public IEnumerator FadeInRoutine()
    {
        ...
        if (enableDebugLog)
        {
            Debug.Log("[Map3SceneFadeController] Fade In xong.");
        }
    }
    ...
    public IEnumerator FadeOutRoutine()
    {
        ...
        if (enableDebugLog)
        {
            Debug.Log("[Map3SceneFadeController] Fade Out xong.");
        }
    }
    ...
    private IEnumerator FadeOutThenLoadSceneRoutine(string sceneName)
    {
        ...
        {
            Debug.LogError("[Map3SceneFadeController] Scene Name đang trống.");
            yield break;
        }

        if (enableDebugLog)
        {
            Debug.Log("[Map3SceneFadeController] Load scene: " + sceneName);
        }
