...
/// <summary>
/// Fade chuyển cảnh cho Map2 bằng UI Toolkit.
/// Không dùng chữ cinematic.
/// 
/// Cơ chế:
/// - Khi vào map: nếu Auto Fade In On Start bật, màn hình đen rồi rõ dần.
/// - Khi chuyển map: màn hình mờ dần sang đen rồi load scene mới.
/// </summary>
public class Map2SceneFadeController : MonoBehaviour
{
    [Header("UI Toolkit")]
    [Tooltip("UIDocument dùng để tạo lớp fade đen phủ toàn màn hình. Kéo Map2HUD hoặc GlobalHUD có UIDocument vào đây.")]
    ...
    public string fadeOverlayName = "map2-scene-fade-overlay";
    ...
    private void SetupOverlay()
    {
        ...
        if (uiDocument == null)
        {
            Debug.LogError("[Map2SceneFadeController] Chưa có UIDocument.");
            return;
        }
        ...
        if (root == null)
        {
            Debug.LogError("[Map2SceneFadeController] Không tìm thấy rootVisualElement.");
            return;
        }
    ...
    public void FadeOutThenLoadScene(string sceneName)
    {
        if (isFading)
        {
            Debug.LogWarning("[Map2SceneFadeController] Đang fade, không gọi lại.");
            return;
        }
    ...
    public IEnumerator FadeInRoutine()
    {
        ...
        if (enableDebugLog)
        {
            Debug.Log("[Map2SceneFadeController] Fade In xong.");
        }
    }
    ...
    public IEnumerator FadeOutRoutine()
    {
        ...
        if (enableDebugLog)
        {
            Debug.Log("[Map2SceneFadeController] Fade Out xong.");
        }
    }
    ...
    private IEnumerator FadeOutThenLoadSceneRoutine(string sceneName)
    {
        ...
        {
            Debug.LogError("[Map2SceneFadeController] Scene Name đang trống.");
            yield break;
        }

        if (enableDebugLog)
        {
            Debug.Log("[Map2SceneFadeController] Load scene: " + sceneName);
        }
